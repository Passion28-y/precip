 ...
 */
        ...
        printf("GetNeighborNode: ERROR: returning NULL for node (%d,%d) requested valid-nbr-index 			%d\n",node->myTag.domainID, node->myTag.index, n);
	PrintNode(node);
	Fatal("GetNeighborNode: NULL neighbor pointer (topology/ghost inconsistency)");
